...
\title{\textbf{Shape-Optimization-Stokes-Darcy-System}}
...
\section*{Code Package Structure}
...
\section{Common Numerical Settings}
...
The interface is updated by a moving body-fitted mesh. The mesh connectivity is kept fixed during the optimization. The FreeFEM++ function \texttt{checkmovemesh} is used to check mesh validity. If the deformed mesh does not satisfy the mesh-quality requirement, the step size is repeatedly halved until an admissible mesh is obtained. No remeshing is used in the present codes.
...
\section{Sec 4.1 Single-interface Around a Porous Region}
...
\section{Sec 4.2 Multi-interface Optimization in an L-shaped Configuration}
...
\section{Sec 4.3 Diffuser Model}
...
\subsection*{Two-dimensional code}
...
\subsection*{Three-dimensional code}
...
\section{Sec 4.4 Embedded Vessel--Tissue Coupling Model}
